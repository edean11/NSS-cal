...
EOS
	...
	def test_find_days_in_month_july_2012
		m = Month.new(07,2012)
		expected = 31
		assert_equal expected, m.find_days_in_month(07,2012)
	end

	def test_find_days_in_month_june_1900
		m = Month.new(06,1900)
		expected = 30
		assert_equal expected, m.find_days_in_month(06,1900)
	end

	def test_find_days_in_month_feb_2012
		m = Month.new(02,2012)
		expected = 29
		assert_equal expected, m.find_days_in_month(02,2012)
	end
